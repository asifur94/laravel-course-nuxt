                        ...
                        <div class="flex">
                          <div class="flex-1 overflow-flex-wrap">
                            <h2 class="text-xl font-bold text-gray-900 mb-1">
                              <NuxtLink to="/" class="text-blue-500 hover:underline">Laravel Core Adventures</NuxtLink>
                            </h2>
                    ...
                    <div class="flex justify-center">
                      ...
                      <div class="w-10/12">
                        <div class="flex">
                          <div class="flex-1 overflow-flex-wrap">
                            <h2 class="text-xl font-bold text-gray-900 mb-1">
                              <router-link to="" class="text-blue-500 hover:underline">Laravel Core Adventures</router-link>
                            </h2>
                            <div class="flex items-center gap-3">
                              <div class="flex items-center space-x-px">
                                <svg class="w-4 h-4 text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
