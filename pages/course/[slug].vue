        ...
        <div class="container mx-auto">
          ...
          <nav class="flex mt-0">
            <ol role="list" class="flex items-center space-x-0.5">
              <li>
                <div class="-m-1">
                  <router-link to="" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700">Home</router-link>
                </div>
              </li>
              <li>
                <div class="flex items-center">
                  ...
                  <div class="-m-1">
                  <router-link to="" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700">Courses</router-link>
                  </div>
                </div>
              </li>
              <li>
                <div class="flex items-center">
                  ...
                  <div class="-m-1">
                     <NuxtLink to="" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700"> {{ course.name   }} </NuxtLink>
                  </div>
                </div>
             </li>
            </ol>
...
const { data: course } = await useFetch(`http://127.0.0.1:8000/api/courses/${route.params.slug}`);
